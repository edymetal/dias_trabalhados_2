export const translations = {
  'pt-BR': {
    ...
    'chart-share-title': 'Percentual por método e mês',
    'chart-share-method': 'Método',
    ...
    'dashboard-delays-basis': 'Clique em um mês para ver as datas previstas e realizadas.',
    'dashboard-delays-details-label': 'Detalhes dos atrasos de {month}',
    'dashboard-delays-expected-label': 'Valor em atraso',
    'dashboard-delays-average-label': 'Média do atraso',
  ...
  'it-IT': {
    ...
    'chart-share-title': 'Percentuale per metodo e mese',
    'chart-share-method': 'Metodo',
    ...
    'dashboard-delays-basis': 'Seleziona un mese per vedere le date previste ed effettive.',
    'dashboard-delays-details-label': 'Dettagli dei ritardi di {month}',
    'dashboard-delays-expected-label': 'Importo in ritardo',
    'dashboard-delays-average-label': 'Ritardo medio',
