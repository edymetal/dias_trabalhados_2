export const translations = {
  'pt-BR': {
    ...
    'skip-to-content': 'Ir para o conteúdo principal',
    'aria-open-menu': 'Abrir menu',
    'aria-close-menu': 'Fechar menu',
    'aria-close-dialog': 'Fechar diálogo',
    'aria-main-navigation': 'Navegação principal',
    'aria-previous-month': 'Mês anterior',
    'aria-next-month': 'Próximo mês',
    'aria-select-date': 'Selecionar data',
    'btn-clear-date': 'Limpar',
    ...
    'dashboard-annual-months-title': 'Recebimentos por Mês',
    'dashboard-annual-months-desc': 'Total recebido nos dias trabalhados de cada mês do ano.',
    'dashboard-annual-months-total': 'Recebido no ano',
    'dashboard-annual-months-received': 'Recebido',
    'dashboard-delays-title': 'Atrasos no recebimento',
    'dashboard-delays-desc': 'Compara a data prevista no ciclo de pagamento com a data em que o dinheiro foi recebido.',
    'dashboard-delays-critical-month': 'Mês mais problemático',
    'dashboard-delays-no-critical': 'Nenhum atraso',
    'dashboard-delays-expected-amount': 'Valor afetado',
    'dashboard-delays-expected-help': 'Total que ficou em atraso e foi recebido após o prazo.',
    'dashboard-delays-total': 'Ciclos com atraso',
    'dashboard-delays-total-help': 'Cada vencimento é contado uma vez, mesmo quando pago em partes.',
    'dashboard-delays-by-month': 'Atrasos por mês',
    'dashboard-delays-basis': 'Organizado pelo mês em que o pagamento deveria ter chegado.',
    'dashboard-delays-events-title': 'Datas previstas x realizadas',
    'dashboard-delays-events-help': 'Consulte os ciclos em atraso de um mês por vez.',
    'dashboard-delays-expected-label': 'Valor em atraso',
    'dashboard-delays-max-label': 'Maior atraso',
    'dashboard-delays-expected-date': 'Previsto',
    'dashboard-delays-paid-date': 'Recebido',
    'dashboard-delays-no-events': 'Nenhum ciclo rastreável foi recebido após o prazo neste mês.',
    'dashboard-delays-one': 'ciclo em atraso',
    'dashboard-delays-many': 'ciclos em atraso',
    'dashboard-delays-day': 'dia',
    'dashboard-delays-days': 'dias',
    'dashboard-delays-navigation-label': 'Navegação dos meses com atrasos',
    'dashboard-delays-previous-month': 'Mês anterior',
    'dashboard-delays-next-month': 'Próximo mês',
    'dashboard-delays-month-position': 'Mês {current} de {total}',
    ...
    'msg-logout-error': 'Não foi possível encerrar a sessão. Tente novamente.',
    ...
    'msg-batch-limit': 'O intervalo pode conter no máximo {count} dias.',
  ...
  'it-IT': {
    ...
    'dialog-confirm-title': 'Conferma azione',
    'skip-to-content': 'Vai al contenuto principale',
    'aria-open-menu': 'Apri menu',
    'aria-close-menu': 'Chiudi menu',
    'aria-close-dialog': 'Chiudi finestra',
    'aria-main-navigation': 'Navigazione principale',
    'aria-previous-month': 'Mese precedente',
    'aria-next-month': 'Mese successivo',
    'aria-select-date': 'Seleziona data',
    'btn-clear-date': 'Cancella',
    ...
    'dashboard-annual-months-title': 'Incassi per Mese',
    'dashboard-annual-months-desc': 'Totale ricevuto per i giorni lavorati in ogni mese dell’anno.',
    'dashboard-annual-months-total': 'Ricevuto nell’anno',
    'dashboard-annual-months-received': 'Ricevuto',
    'dashboard-delays-title': 'Ritardi negli incassi',
    'dashboard-delays-desc': 'Confronta la data prevista dal ciclo di pagamento con la data in cui il denaro è stato ricevuto.',
    'dashboard-delays-critical-month': 'Mese più problematico',
    'dashboard-delays-no-critical': 'Nessun ritardo',
    'dashboard-delays-expected-amount': 'Importo in ritardo',
    'dashboard-delays-expected-help': 'Totale rimasto in ritardo e ricevuto dopo la scadenza.',
    'dashboard-delays-total': 'Cicli in ritardo',
    'dashboard-delays-total-help': 'Ogni scadenza viene conteggiata una volta, anche se pagata a rate.',
    'dashboard-delays-by-month': 'Ritardi per mese',
    'dashboard-delays-basis': 'Organizzato in base al mese in cui il pagamento avrebbe dovuto arrivare.',
    'dashboard-delays-events-title': 'Date previste ed effettive',
    'dashboard-delays-events-help': 'Consulta i cicli in ritardo un mese alla volta.',
    'dashboard-delays-expected-label': 'Importo in ritardo',
    'dashboard-delays-max-label': 'Ritardo massimo',
    'dashboard-delays-expected-date': 'Previsto',
    'dashboard-delays-paid-date': 'Ricevuto',
    'dashboard-delays-no-events': 'Nessun ciclo tracciabile è stato ricevuto dopo la scadenza questo mese.',
    'dashboard-delays-one': 'ciclo in ritardo',
    'dashboard-delays-many': 'cicli in ritardo',
    'dashboard-delays-day': 'giorno',
    'dashboard-delays-days': 'giorni',
    'dashboard-delays-navigation-label': 'Navigazione dei mesi con ritardi',
    'dashboard-delays-previous-month': 'Mese precedente',
    'dashboard-delays-next-month': 'Mese successivo',
    'dashboard-delays-month-position': 'Mese {current} di {total}',
    ...
    'msg-logout-error': 'Impossibile terminare la sessione. Riprova.',
    ...
    'msg-batch-limit': 'L’intervallo può contenere al massimo {count} giorni.',
