export const translations = {
  'pt-BR': {
    ...
    'dashboard-delays-expected-amount': 'Deveria ter recebido em dia',
    'dashboard-delays-expected-help': 'Soma dos valores que chegaram após o prazo.',
    'dashboard-delays-total': 'Pagamentos atrasados',
    'dashboard-delays-total-help': 'Ocorrências com data prevista e realizada diferentes.',
    ...
    'dashboard-delays-events-help': 'Detalhes dos recebimentos identificados com atraso.',
    'dashboard-delays-expected-label': 'Valor previsto',
    'dashboard-delays-max-label': 'Maior atraso',
    'dashboard-delays-expected-date': 'Previsto',
    'dashboard-delays-paid-date': 'Recebido',
    'dashboard-delays-no-events': 'Nenhum pagamento rastreável foi recebido após o prazo neste ano.',
    'dashboard-delays-one': 'atraso',
    'dashboard-delays-many': 'atrasos',
  ...
  'it-IT': {
    ...
    'dashboard-delays-expected-amount': 'Da ricevere puntualmente',
    'dashboard-delays-expected-help': 'Somma degli importi arrivati dopo la scadenza.',
    'dashboard-delays-total': 'Pagamenti in ritardo',
    'dashboard-delays-total-help': 'Occorrenze con data prevista ed effettiva diverse.',
    ...
    'dashboard-delays-events-help': 'Dettagli degli incassi identificati in ritardo.',
    'dashboard-delays-expected-label': 'Importo previsto',
    'dashboard-delays-max-label': 'Ritardo massimo',
    'dashboard-delays-expected-date': 'Previsto',
    'dashboard-delays-paid-date': 'Ricevuto',
    'dashboard-delays-no-events': 'Nessun pagamento tracciabile è stato ricevuto dopo la scadenza quest’anno.',
    'dashboard-delays-one': 'ritardo',
    'dashboard-delays-many': 'ritardi',
